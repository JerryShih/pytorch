...
# succeed because "pthread_create" is in libasan.so. However it does not
# have a full pthread implementation, other pthread functions doesn't exist
# in libasan.so[2]. If we need some pthread advanced functions, we still
